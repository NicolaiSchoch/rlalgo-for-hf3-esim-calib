...
rmsefilename = 'rmse_value_list.txt'
...
rmse_value_list_file.write("RMSE-Value in Step " + str(stepnum) + ": " + str(rmse_value) + '\n')
...
simfilename_base = 'simresults_defcoords_list' #.csv'
simfilename = ''
stepnum = int(stepnum)
...
simresults_list_file.write("\nSimResultsDefCoords in Step " + str(stepnum) + ":\n")
